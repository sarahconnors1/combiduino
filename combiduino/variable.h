...
struct SEND_DATA_STRUCTURE{
  ...
  int PW_actuel;  // temps d'ouverture complet des injecteurs (normal + accel) corrige par le Xtau ou pas
  int qte_paroi ; // qte actuellement sur la paroi
...
//----------------------declaration TPS
const byte nbre_mesure_TPS = 2;
const int TPS_check_per_S = 12 ; // nombre de calcul par seconde d'acceleration / depression
int previous_TPS = 0;
int sum_TPS = 0;
byte count_TPS = 0;
...
int sum_lambda = 0;
byte count_lambda = 0;
const int LBD_check_per_S = 10 ; // nombre de calcul par seconde d'acceleration / depression
...
#if PID_EGO_USED==1
double AFR_actuel_double = 147;
double correction_lambda_actuel_double = 100;
double AFR_objectif_double =147;
#endif
...
const unsigned long interval_time_check_lambda = 1000 / (LBD_check_per_S * nbre_mesure_lambda); // lambda  50ms
...
const unsigned long interval_time_check_AFR_correction = 100 ; // recalcul correction tous les 50ms
unsigned long time_check_AFR_correction = 2000; 
